...
function getRectangleString(width, height) {
  ...
  result += `┌${horizantal.repeat(width - 2)}┐\n`;
...
function isString(value) {
  ...
  if (Object.getPrototypeOf(value) === Object.getPrototypeOf('')) return true;
  return false;
}
...
function getCardId(value) {
  let index = 0;
  const firrsInt = +value.slice(0, value.length - 1) - 1;
